  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/selltement-finance" element={<SettlementFinanceDashboard />}/>
        <Route path="/data-analytics" element={<DataAnalyticsPage />} />
        <Route path="/security-safety" element={<SecuritySafetyPage />} />

        {/* 230925 */}
          <Route path="/Observability" element={<ObservabilityReliabilityPage />}/>
          ...
          <Route path="/futuristic" element={<FuturisticDifferentiatorsPage/>}/>
           <Route path="/governance-security" element={<GovernanceSecurityTrustPage/>}/>
          ...
          <Route path="/dashboards-cms" element={<DashboardsCMSPage/>}/>    
           ...
           <Route path="/ystudio-notification" element={<YStudioNotificationPage/>} />
